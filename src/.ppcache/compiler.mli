(*51373cda004097ebec1cbed7bf2332dc src/compiler.mli *)
#1 "src/compiler.mli"
open Util
open Data
type flags =
...
val unit_of_ast :
  flags:flags -> header:header -> Ast.Program.t -> compilation_unit
val assemble_units :
  flags:flags -> header:header -> compilation_unit list -> program
val append_units :
